...
def main():
    ...
    if festo.checkPallet(PACKING_IP) == False: return
    ...
    current_PNo = PNo[str(festo.get_product_number(PACKING_IP))][1] # MAKE THE OPC-UA COMMAND FOR GETTING THE PRODUCT NUMBER
